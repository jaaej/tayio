...
| Classes view | Calendar + attendance log + reschedule entry point | ✅ | ✅ | `/parent/classes` (combined attendance + bookings on 2026-05-26). **Reschedule/cancel/credit UI ported to the shared interactive timetable (2026-07-30)** - see the "Reschedule and class credits" rows below. |
